    ...
    -->
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item "><a class="nav-link" href="showTable.htm">
					...
					<li class="nav-item active"><a class="nav-link"
						href="account.htm"> <i class="material-icons">account_circle</i>
							<p>Account Manage</p>
					</a></li>
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Account Pages</a>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form:form action="" modelAttribute="accountForm">
										<div class="row">

											<div class="col-md-3">
												<div class="form-group">
													<label class="bmd-label-floating">Username</label> <form:input
														type="text" class="form-control" path="username" />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Password</label> <form:input
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Full name</label> <form:input
														type="text" class="form-control" path="fullname" />
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Role</label> <form:input
														type="text" class="form-control" path="roles" />
												</div>
											</div>
										</div>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<c:forEach var="r" items="${getAccount }">
												<tr>
													<td>${r.username }</td>
													<td>${r.password }</td>
													<td>${r.roles }</td>
													...
													<td class="text-primary">
														<a href="${r.username}editAccount.htm"><button class="btn btn-primary">Edit</button></a>
													</td> 
												</tr>
											</c:forEach>
