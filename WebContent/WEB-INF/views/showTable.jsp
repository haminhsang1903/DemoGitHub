    ...
    -->
		...
		<div class="main-panel">
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Show Table</a>
					</div>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<c:forEach var="r" items="${getAllTable }">
							<c:if test="${r.status == true }">
								<div class="col-md-4">
									<div class="card card-profile">
										...
										<div class="card-body">
											<h3 class="card-category text-gray">${r.tbl.nameTable }</h3>
											<h4 class="card-title"></h4>
											<p class="card-description"></p>
											<a href="${r.tbl.idTable}order.htm"
												class="btn btn-primary btn-round">Order</a> <a
												href="${r.tbl.idTable}pay.htm"
												class="btn btn-success btn-round">Pay</a>
										</div>
									</div>
								</div>
							</c:if>
								...
								<div class="col-md-4">
									<div class="card card-profile">
										...
										<div class="card-body">
											...
											<p class="card-description"></p>
											<a href="${r.tbl.idTable}order.htm"
												class="btn btn-primary btn-round">Order</a>
										</div>
									</div>
								</div>
							</c:if>
