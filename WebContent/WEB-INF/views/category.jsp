			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="nav-item   "><a class="nav-link"
						href="index.htm"> <i class="material-icons">dashboard</i>
							<p>Dashboard</p>
					</a></li>
					...
					<li class="nav-item active"><a class="nav-link"
						href="category.htm"> <i class="material-icons">category</i>
							<p>Category Food</p>
					</a></li>
					</c:if>
					<li class="nav-item "><a class="nav-link"
						href="login.htm"> <i class="material-icons">rotate_left</i>
							<p>Log out</p>
					</a></li>
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Category Pages</a>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form:form action="categoryAC.htm" method="post" modelAttribute="categoryForm">
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<label class="bmd-label-floating">ID</label> <form:input
														type="text" class="form-control" path="id" />
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Name</label> <form:input
														type="password" class="form-control" path="name" />
												</div>
											</div>
										</div>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
										<c:forEach var="r" items="${getAllCategory }">
											<tr>
												<td>${r.id }</td>
												<td>${r.name }</td>
