				...
				<ul class="nav">
					...
					<c:if test="${Role == 3 }">
						...
						<li class="nav-item active"><a class="nav-link"
							href="menu.htm"> <i class="material-icons">content_paste</i>
								<p>Menu Manage</p>
						</a></li>
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Menu Pages</a>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form:form action="menuAc.htm" method="POST"
													...
													<ul class="nav nav-tabs" data-tabs="tabs">
														<li class="nav-item"><a class="nav-link active"
															href="#profile" data-toggle="tab"> <i
																class="material-icons">cake</i> Category 1
																<div class="ripple-container"></div>
														</a></li>
														<li class="nav-item"><a class="nav-link"
															href="#messages" data-toggle="tab"> <i
																class="material-icons">local_bar</i> Category 2
																<div class="ripple-container"></div>
														</a></li>
														<li class="nav-item"><a class="nav-link"
															href="#settings" data-toggle="tab"> <i
																class="material-icons">local_dining</i> Category 3
																<div class="ripple-container"></div>
														</a></li>
													</ul>
												</div>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="profile">
													<table class="table">
														...
														<tbody>
															<c:forEach var="r" items="${getAllMenu }">
																<tr>
																	<td>${r.id }</td>
																	<td>${r.nameFood }</td>
																	<td>${r.image }</td>
																	<td>${r.price }</td>
																	<td>${r.idCategory.name }</td>
													...
													<table class="table">
														<tbody>
															<tr>
																...
																<td>Flooded: One year later, assessing what was
																	lost and what was found when a ravaging rain swept
					...
					<footer class="footer">
						<div class="container-fluid">
							<nav class="float-left">
								<ul>
									<li><a href="https://www.creative-tim.com"> BigBee
											Group </a></li>
